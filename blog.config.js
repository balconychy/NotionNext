...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'balconychy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '积极的问题解决者和创新者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.tedcai.ccc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'balconychy, 博客,贝壳里奇', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/1661440761', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/balconychy', // 你的twitter个人主页
  ...
  PRISM_THEME_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-duotone-light.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes
  ...
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'test1', // 你的Github仓库名，例如 'NotionNext'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '贝壳里奇 Blog', // 站点标题 ，被notion中的页面标题覆盖
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '积极的问题解决者和创新者', // 站点描述，被notion中的页面描述覆盖
